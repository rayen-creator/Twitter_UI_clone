...
const TweetWidget = () => {
    return (  
        <div className="flex flex-row p-3 border-b w-full">
        <div className='p-2'>
            <img src={logo} alt="profile pic" className=" w-11 h-10 object-cover rounded-full " />
        </div>
        <div className='flex flex-col  w-full px-2'>
            <input
                type="text"
                className='bg-transparent focus:ring-0 outline-none text-xl h-16 pb-4'
            ...
            <div className="flex flex-row justify-between items-center text-primary">
                ...
                <button className="bg-primary text-white text-md font-bold rounded-full px-4 py-2">Tweet</button>
            </div>
        </div>
    </div>
     );
